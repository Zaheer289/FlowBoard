...
function Sidebar(){
    ...
    return (
        <aside className="w-1/4 xl:w-1/5 hidden md:block min-h-screen bg-cyan-950 text-white mr-6 flex flex-col">
            ...
            <button className='flex gap-5 items-center px-10 py-3 hover:bg-cyan-900 w-full'>
